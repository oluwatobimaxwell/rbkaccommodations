...
!(function (t) {
  ...
  t(".lightbox-group-gallery-item").each(function () {
    ...
    t(document).on("click", ".submit", function () {
      ...
      (l.length > 0 && (l.is(":checked") || ((e = !0), l.addClass("error"))),
      "undefined" != typeof grecaptcha && null !== grecaptcha) &&
    ...
    t(".swiper-container:not( .instafeed-wrapper )").each(function () {
      ...
      if (null != a) {
        ...
        if ("" != o && null != o) {
          ...
          a.on = {
            init: function () {
              j() <= n ? this.changeDirection(o) : this.changeDirection(i),
                this.update();
            },
            resize: function () {
              j() <= n ? this.changeDirection(o) : this.changeDirection(i),
        ...
        if ("" != a.thumbs && null != a.thumbs) {
          ...
          if ("" != r && null != r) {
            ...
            a.thumbs.swiper.on = {
              init: function () {
                j() <= n ? this.changeDirection(r) : this.changeDirection(s),
                  this.update();
              },
              resize: function () {
                j() <= n ? this.changeDirection(r) : this.changeDirection(s),
        ...
        "" != l &&
          ...
          (a.on.slideChange = function () {
            t(".swiper-pagination-current").length > 0 &&
              t(".swiper-pagination-current").html(z(this.realIndex + 1)),
  ...
  function B() {
    for (var e = 0; e < c.length; e++) {
      ...
      "" != a &&
        null != a &&
        (j() <= a ? t.destroy(!1, !0) : t.destroyed && (c.splice(e, 1), A()));
    }
  }
  function W() {
    setTimeout(function () {
  ...
  function U() {
    ...
    (!t(".navbar").hasClass("top-space") &&
      ...
      t(".mobileoff-fullscreen-top-space").length >= 0 &&
        j() > 1023 &&
        t(".mobileoff-fullscreen-top-space").css("height", N() - e + "px"),
      t(".fullscreen-top-space").length >= 0 &&
        t(".fullscreen-top-space").css("height", N() - e + "px"),
      (t(".sidebar-nav-action").length > 0 ||
        t(".side-menu-header").length > 0) &&
        (j() <= i
          ? t("body").css("padding-top", e + "px")
    ...
    <div class="theme-demos">
        <div class="all-demo email">
          <a href="mailto:info@rbkaccommodations.com" target="_blank">
            ...
            <div class="theme-wrapper">
              <div>
                <i class="feather icon-feather-mail  align-middle"></i>
                <p>Email</p>
              </div>
            </div>
          </a>
        ...
        <div class="all-demo call">
          <a href="tel:+234801RBK" target="_blank">
            ...
            <div class="theme-wrapper">
              <div>
                <i class="feather  icon-feather-phone-call  align-middle"></i>
                <p>Call</p>
              </div>
            </div>
          </a>
